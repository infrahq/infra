...
func RunLocalClient() error {
	...
	mux.HandleFunc("/client/", clientProxyHandler)
...
func clientProxyHandler(w http.ResponseWriter, r *http.Request) {
	homeDir, _ := os.UserHomeDir() // home dir already error checked
