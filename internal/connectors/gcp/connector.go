...
// 	genericconnector "github.com/infrahq/infra/internal/connector"
...
// 	certCache   *genericconnector.CertCache
// 	options     Options
// }
...
// 	certCache := genericconnector.NewCertCache([]byte(options.CACert), []byte(options.CAKey))
