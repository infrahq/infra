...
func (o *InfraAPIToken) GetExpires() int64 {
...
// and a boolean to check if the value has been set.
func (o *InfraAPIToken) GetExpiresOK() (*int64, bool) {
	if o == nil || o.Expires == nil {
		return nil, false
	}
...
func (o *InfraAPIToken) HasExpires() bool {
	if o != nil && o.Expires != nil {
		return true
	}
...
func (o *InfraAPIToken) SetExpires(v int64) {
	o.Expires = &v
}
