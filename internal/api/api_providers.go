...
func (r APICreateProviderRequest) Body(body ProviderRequest) APICreateProviderRequest {
	r.body = &body
	return r
}

func (r APICreateProviderRequest) Execute() (Provider, *_nethttp.Response, error) {
	return r.APIService.CreateProviderExecute(r)
}

/*
CreateProvider Add an identity provider

 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return APICreateProviderRequest
*/
func (a *ProvidersAPIService) CreateProvider(ctx _context.Context) APICreateProviderRequest {
	return APICreateProviderRequest{
		APIService: a,
		ctx:        ctx,
	}
...
//  @return Provider
func (a *ProvidersAPIService) CreateProviderExecute(r APICreateProviderRequest) (Provider, *_nethttp.Response, error) {
	var (
...
/*
DeleteProvider Delete a provider by ID

 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id Provider ID
 @return APIDeleteProviderRequest
*/
func (a *ProvidersAPIService) DeleteProvider(ctx _context.Context, id string) APIDeleteProviderRequest {
	return APIDeleteProviderRequest{
		APIService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *ProvidersAPIService) DeleteProviderExecute(r APIDeleteProviderRequest) (*_nethttp.Response, error) {
	var (
...
func (r APIUpdateProviderRequest) ProviderRequest(providerRequest ProviderRequest) APIUpdateProviderRequest {
	r.providerRequest = &providerRequest
	return r
}

func (r APIUpdateProviderRequest) Execute() (Provider, *_nethttp.Response, error) {
	return r.APIService.UpdateProviderExecute(r)
}

/*
UpdateProvider Update provider by ID

 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id Provider ID
 @return APIUpdateProviderRequest
*/
func (a *ProvidersAPIService) UpdateProvider(ctx _context.Context, id string) APIUpdateProviderRequest {
	return APIUpdateProviderRequest{
		APIService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
//  @return Provider
func (a *ProvidersAPIService) UpdateProviderExecute(r APIUpdateProviderRequest) (Provider, *_nethttp.Response, error) {
	var (
