...
// Groups provides a mock function with given fields: domain, clientID, apiToken
func (_m *Okta) Groups(domain string, clientID string, apiToken string) (map[string][]string, error) {
	ret := _m.Called(domain, clientID, apiToken)
