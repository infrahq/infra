...
func TestHumanDuration(t *testing.T) {
	...
	assert.Equal(t, "Less than a second", HumanDurationWithCase(450*time.Millisecond, true))
	assert.Equal(t, "less than a second", HumanDurationWithCase(450*time.Millisecond, false))
	...
	assert.Equal(t, "About a minute", HumanDurationWithCase(1*time.Minute, true))
	assert.Equal(t, "about a minute", HumanDurationWithCase(1*time.Minute, false))
	...
	assert.Equal(t, "About an hour", HumanDurationWithCase(1*time.Hour+29*time.Minute, true))
	assert.Equal(t, "about an hour", HumanDurationWithCase(1*time.Hour+29*time.Minute, false))
