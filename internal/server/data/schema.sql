...
CREATE UNIQUE INDEX idx_access_keys_issued_for_user_name ON access_keys USING btree (organization_id, issued_for_user, name) WHERE (deleted_at IS NULL);
