...
func TestCreateOrganization(t *testing.T) {
	runDBTests(t, func(t *testing.T, db *DB) {
		org := &models.Organization{
			...
			CreatedBy:           777,
			AllowedLoginDomains: models.CommaSeparatedStrings{"example.com", "infrahq.com"},
		}
...
func TestUpdateOrganization(t *testing.T) {
	runDBTests(t, func(t *testing.T, db *DB) {
		...
		updated.AllowedLoginDomains = []string{"example.com"}
		...
		expected := &models.Organization{
			...
			CreatedBy:           7123,
			AllowedLoginDomains: []string{"example.com"},
		}
		assert.DeepEqual(t, expected, actual, cmpModel)
	})
}
