                ...
                <div className="px-4 py-3.5 sm:px-6">
                    <div className="relative flex justify-between">
                        ...
                        <div className="flex items-center lg:hidden">
                            <Popover.Button className="-mx-2 rounded-lg p-2 inline-flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-rose-500">
                            ...
                            <Menu as="div" className="flex-shrink-0 relative ml-5">
                                {({ open }) => (
                                    ...
                                    >
                                        <Menu.Items
                                            static
                                            className="origin-top-right absolute z-10 right-0 mt-2 w-48 rounded-lg cursor-pointer shadow-lg bg-black text-white ring-1 ring-black ring-opacity-5 py-1 focus:outline-none"
                                        >
                                            {userNavigation.map((item) => (
                                                ...
                                                {({ active }) => (
                                                    ...
                                                    className={classnames(active ? 'bg-gray-800' : '', 'block py-2 px-4 text-white')}
                                                    >
                                                    {item.name}
                                                    </a>
                                                )}
                            ...
                            <Link href={item.href} key={item.name}>
                                <a
                                    ...
                                    className={classnames(
                                        ...
                                        'block rounded-lg py-2 px-3 text-base font-medium'
                                    )}
                                >
                                    {item.name}
                                </a>
                    ...
                    <div className="border-t border-gray-200 pt-4 pb-3">
                        ...
                        <div className="mt-3 max-w-3xl mx-auto px-2 space-y-1 sm:px-4">
                            ...
                            <a
                                key={item.name}
                                onClick={item.onClick}
                                className="block rounded-lg py-2 px-3 text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50"
                            >
                                {item.name}
                            </a>
                            ))}
