            ...
            <div>
                ...
                {users.map(user => (
                  <tr key={user.id} className="hover:bg-gray-50 cursor-pointer">
                    <td className="px-1 py-3 whitespace-nowrap text-gray-900">{user.email}{user.admin ? <span className="inline-flex items-center ml-2 px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
        Admin
      </span> : null}</td>
...
export default function Users () {
  return (
    <Layout>
      <div className="mt-4">
        <div className="max-w-7xl mx-auto mb-6 px-4 sm:px-6 md:px-8">
