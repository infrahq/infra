...
export default function () {
  ...
  return (
    <div className='flex flex-col justify-center items-center w-full max-w-md mx-auto mt-40 border rounded-lg border-gray-950'>
      <HeaderIcon size={12} iconPath='/infra-color.svg' />
      <h1 className='text-header font-bold'>Welcome to Infra</h1>
      <h2 className='text-title text-center max-w-xs my-3 text-gray-300'>You've successfully installed Infra.<br />Set up your admin user to get started.</h2>
