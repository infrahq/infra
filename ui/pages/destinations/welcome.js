          ...
          <div className='mb-2'>
            <h3 className='text-base font-medium leading-6 text-gray-900'>
              ...
              <a
                ...
                rel='noreferrer'
              >
                Download the CLI <ExternalLinkIcon className='ml-0.5 h-3 w-3' /> </a> and sign in to your Infra account
            </h3>
          </div>
          ...
          <div className='mb-2'>
            ...
            <p className='mt-1 text-sm text-gray-500'>
              ...
              <a
                ...
                rel='noreferrer'
              >
                this primer <ExternalLinkIcon className='ml-0.5 h-3 w-3' /> </a> to learn more about the basics
